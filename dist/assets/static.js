...
•━━━━━━━━━━━━━━━━━•`,
        ...
        baseRoles: [
          {
            ...
            deny: [
              _discord.Permissions.FLAGS.VIEW_CHANNEL,
              _discord.Permissions.FLAGS.CREATE_PRIVATE_THREADS,
              _discord.Permissions.FLAGS.CREATE_PUBLIC_THREADS,
              _discord.Permissions.FLAGS.SEND_MESSAGES_IN_THREADS,
            ],
          },
          {
            id: "955773099897389116",
            ...
            deny: [
              ...
              _discord.Permissions.FLAGS.CREATE_PUBLIC_THREADS,
              _discord.Permissions.FLAGS.SEND_MESSAGES_IN_THREADS,
              _discord.Permissions.FLAGS.ATTACH_FILES,
              _discord.Permissions.FLAGS.ADD_REACTIONS,
            ],
          },
          {
  ...
  TwitchApi: {
    ...
    botsRole: {
      ...
      allow: [
        _discord.Permissions.FLAGS.VIEW_CHANNEL,
        _discord.Permissions.FLAGS.CONNECT,
      ],
    },
    liveStreamChannelRoles: [
      ...
      },
      {
        ...
        deny: [
          ...
          _discord.Permissions.FLAGS.SEND_MESSAGES_IN_THREADS,
          _discord.Permissions.FLAGS.CONNECT,
          _discord.Permissions.FLAGS.SEND_MESSAGES,
        ],
      },
    ],
    streamers: [
